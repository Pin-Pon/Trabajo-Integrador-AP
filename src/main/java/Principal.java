public class Principal {
    public static void main(String[] args) {
        ...
        Participante participante3 = new Participante("Mario", Pronosticos.LOCAL_GANO, 3);
        Participante participante4 = new Participante("Pupa", Pronosticos.LOCAL_GANO, 3);
        Participante participante5 = new Participante("Tamara", Pronosticos.LOCAL_GANO, 3);
        Participante participante6 = new Participante("Roberto", Pronosticos.LOCAL_GANO, 3);
        Participante participante7 = new Participante("Sofia", Pronosticos.LOCAL_GANO, 3);
        ...
        Partido fecha2 = new Partido("oca", "RiL", Pronosticos.LOCAL_GANO, 2);
        Partido fecha3 = new Partido("ca", "RiP", Pronosticos.VISITANTE_GANO, 3);
        Partido fecha4 = new Partido("Roca", "RiD", Pronosticos.LOCAL_GANO, 4);
        Partido fecha5 = new Partido("Poca", "RiM", Pronosticos.EMPATE, 5);
        Partido fecha6 = new Partido("Loca", "RNi", Pronosticos.LOCAL_GANO,6);
        Partido fecha7 = new Partido("Toca", "RiC", Pronosticos.LOCAL_GANO, 7);
        Partido fecha8 = new Partido("Moca", "RiX", Pronosticos.LOCAL_GANO, 8);
